...
> 日期：2026-08-31  
> 状态：Stage 14 实施设计；不是交付、验收或 verified 声明  
...
list/page/repair均bounded；PR级10,000 notifications证明 O(page) repair、flat multi-room list、badge一致与无半 cache。notification worker纳入 FT-14 closed inventory：max queue/batch/active/timeout/attempt、startup recovery、oldest age、warning/critical、dead-letter、shutdown drain与 archive freeze；alert仅含 opaque ID/state/age/count。

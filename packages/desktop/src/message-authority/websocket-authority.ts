...
export function parseMessageAuthorityServerFrame(raw: string): ParsedFrame | undefined {
  ...
  switch (value.type) {
    ...
    case "error": {
      if (isProjectLoopWireError(value)) {
        ...
        return {
          ...
          error: new MessageAuthorityTransportError(
            ...
            undefined,
            undefined,
            structuredClone(notificationError === undefined ? value : {
              ...value,
      ...
      if (closedError === undefined && toolSafetyError === undefined &&
          notificationError === undefined) return undefined;
      ...
      return { type: "error",
        ...
        error: new MessageAuthorityTransportError(code, closedError, undefined, undefined, undefined,
          toolSafetyError, notificationError) };
    }

...
describe("Project Loop production Worker adapter", () => {
  ...
  it.each([
    ...
    [{ ...base, type: "project.obstacle.transition" as const, factId: "question-1",
      expectedRevision: 2, obstacleKind: "open_question" as const,
      action: "reopen" as const, reason: "Follow-up required" },
    { factKind: "open_question", factId: "question-1", transition: "obstacle.reopen",
      payload: { reason: "Follow-up required" } }],
    ...
    [{ ...base, type: "project.transfer.propose" as const, transferProposalId: "transfer-agent",
      subjectKind: "blocker" as const, subjectId: "blocker-1", expectedRevision: 2,
      toOwner: { kind: "agent" as const, actorId: "agent-2" }, reason: "specialist" },
    { factKind: "blocker", factId: "blocker-1", transition: "obstacle.transfer_propose",
      payload: { transferProposalId: "transfer-agent", toOwnerKind: "agent",
        toOwnerActorId: "agent-2", reason: "specialist", expiresAt: "2026-08-25T04:15:00.000Z" } }],

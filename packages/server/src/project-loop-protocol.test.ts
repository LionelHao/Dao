...
describe("FT-09 Project Loop protocol", () => {
  it.each([
    ...
    { ...mutation, type: "project.proposal.create", proposalId: "proposal-2", baseRevision: null,
      source, payload: { kind: "request", title: "Confirm window", description: "Please confirm",
        target: { actorId: "human-2", kind: "human" }, acceptanceMode: "next_action" } },
    { ...mutation, type: "project.proposal.create", proposalId: "proposal-3", baseRevision: null,
      source, payload: { kind: "next_action", title: "Ship", description: "Ship build",
        owner: { actorId: "human-2", kind: "human" }, dueAt: null, deliverable: "Signed build",
        acceptanceCriteria: [{ criterionId: "criterion-1", text: "Smoke green" }],
        verifier: null } },
    ...
    { ...mutation, type: "project.transfer.resolve", transferProposalId: "transfer-1",
      expectedRevision: 1, resolution: "accepted", reason: null },
  ...
  it.each([
    ...
    { ...mutation, type: "project.transfer.resolve", transferProposalId: "transfer-1",
      expectedRevision: 1, resolution: "rejected", reason: null },
    { ...mutation, type: "project.proposal.create", proposalId: "proposal-1", baseRevision: null,

...
describe("FT-09 Project Loop protocol", () => {
  it.each([
    ...
    { ...fact, type: "project.obstacle.transition", obstacleKind: "blocker", action: "reopen",
      reason: "Work resumed" },
    ...
    { ...mutation, type: "project.transfer.propose", transferProposalId: "transfer-agent",
      subjectKind: "blocker", subjectId: "blocker-1", expectedRevision: 1,
      toOwner: { actorId: "agent-2", kind: "agent" }, reason: "Agent specialist" },
  ...
  it.each([
    ...
    { ...mutation, type: "project.transfer.propose", transferProposalId: "transfer-agent-extra",
      subjectKind: "blocker", subjectId: "blocker-1", expectedRevision: 1,
      toOwner: { actorId: "agent-2", kind: "agent", principalActorId: "forged" }, reason: "spoof" },
